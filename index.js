...
// بيانات البوت
const botToken = '7549184182:AAHj8OjP-aBJTpWLIJcso5oBePupiIEpudI'; // ضع هنا توكن البوت الخاص بك
const botUsername = 'sh_sh_mood7bot'; // ضع هنا يوزر البوت الخاص بك بدون @
const bot = new TelegramBot(botToken, { polling: true });

const developerChannels = ['@www_lovi']; // قنوات المطور
...
bot.on('callback_query', async (callbackQuery) => {
    ...
    } else if (data === 'add_vip' && chatId == 6000110447 ) {
    ...
    } else if (data === 'remove_vip' && chatId == 6000110447 ) {
...
function isDeveloper(chatId) {
    ...
    const developerChatId = 6000110447 ;
